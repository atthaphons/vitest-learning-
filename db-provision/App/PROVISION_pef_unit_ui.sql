-- Provisions the isolated App unit-test database for UI / Playwright tests used by:
--   backend/api/src/main/resources/application-ui-test.yaml
--   individual-function-ui-test/config/env.ts
--
...
DROP DATABASE IF EXISTS pef_unit_ui;

CREATE DATABASE pef_unit_ui
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_0900_ai_ci;

CREATE USER IF NOT EXISTS 'pef_unit_ui'@'%' IDENTIFIED BY 'pef_unit_ui';
GRANT ALL PRIVILEGES ON pef_unit_ui.* TO 'pef_unit_ui'@'%';
FLUSH PRIVILEGES;
